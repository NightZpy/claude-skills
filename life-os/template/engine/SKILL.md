...
goal node (group lenyn, in the matrix) + a ritual for the recurring part + a deadline for
the dated goal + a pinned memory note — never just prose.

**Reference instance (canonical example of every file):**
`/Users/lenyndev/Documents/projects/connectly/docs/agent-evals-q2/` — q3-data.json,
q3-prompt.txt, _q3-shell.tpl, build_q3.py, update_q3.py, q3-map-2026.html, design-docs/.
Also a PRIVATE git repo: https://github.com/NightZpy/employee-os (auto-commit+push on
...
python3 update_q3.py add-issue --id AG-#### --parent <theme> --sub .. [--owner lenyn|other]
